...
# NB - this script has almost outlived its usefulness. Once the dust has settled on the derived_tables stuff, this can be removed (and removed from cron)
...
psql ixmaps -c "select st0.traceroute_id,st0.hop,i.ip_addr,i.hostname,i.asnum,i.mm_lat,i.mm_long,i.lat,i.long,i.mm_city,i.mm_region,i.mm_country,i.mm_postal,i.gl_override,st0.rtt1,st0.rtt2,st0.rtt3,st0.rtt4 into script1 from ip_addr_info as i join script_temp0 as st0 on i.ip_addr=st0.ip_addr;"
