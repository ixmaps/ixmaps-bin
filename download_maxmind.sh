...
# MM_DATA_PATH="/Users/colin/Dev/IXmaps/maxmind"

rm $MM_DATA_PATH/*

wget -P $MM_DATA_PATH https://geolite.maxmind.com/download/geoip/database/GeoLite2-City.tar.gz
wget -P $MM_DATA_PATH https://geolite.maxmind.com/download/geoip/database/GeoLite2-Country.tar.gz
...
tar -xvzf $MM_DATA_PATH/GeoLite2-Country.tar.gz --strip-components=1 -C $MM_DATA_PATH
